...
apt-get -o Dpkg::Options::="--force-confold" install --only-upgrade neutron-server neutron-plugin-ml2  neutron-l3-agent neutron-dhcp-agent neutron-metadata-agent
